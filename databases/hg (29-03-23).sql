...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 29 mrt 2023 om 09:39
...
--
ALTER TABLE `bestelregel`
  MODIFY `BestelRegel-ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tafels`
  MODIFY `TafelID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
